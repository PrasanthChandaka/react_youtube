...
const Footer = () => {
  return (
    <div className="bg-[#0F0F0F] border-t-[1px] text-white border-gray-500 flex min-[640px]:hidden h-[56px] w-full justify-around items-center fixed bottom-0">
      ...
      <NavLink
        to="/shorts"
        className="flex items-center flex-col gap-1 w-[60px]"
      >
        <SiYoutubeshorts size={20} />
        <p className="text-[12px]">Shorts</p>
      </NavLink>

      <button type="button" className="flex items-center w-[60px]">
      ...
      <NavLink to="/you" className="flex items-center flex-col gap-1 w-[60px]">
