...
const Header = () => {
  ...
  return (
    <>
      <div
        className={`bg-[#0F0F0F] text-white font-normal relative h-[56px] w-full flex justify-between items-center md:gap-4 px-[16px] py-0 ${
          search ? "hidden" : "block"
        }`}
      >
        <div className="flex items-center relative">
          ...
          <p className="absolute top-[-5px] right-[-15px] font-extralight text-[10px]">
            IN
          </p>
          <Link to="/">
            <svg
        ...
        <div className="flex items-center gap-3 h-[45px] w-[100%] flex-grow-0 flex-shrink basis-[700px] ml-[20px] max-[640px]:hidden">
          <div className="h-[45px] flex rounded-full outline-none border-[1.5px] border-gray-700 overflow-hidden w-full">
            ...
            <input
              ...
              placeholder="Search"
            />
            <div className="h-full bg-[#222222] p-5 flex items-center cursor-pointer">
              <CiSearch size={30} />
            </div>
          </div>
          <div className="flex items-center bg-[#272727] h-[45px] w-[45px] p-4 rounded-full cursor-pointer">
            <FaMicrophone size={25} color="white" />
          </div>
        </div>

        <div className="flex gap-5 items-center bg-[#0F0F0F] h-[56px] relative">
          <CiSearch
            size={30}
            color="white"
            className="cursor-pointer hidden ml-[20px] max-[640px]:block"
          ...
          <button
            type="button"
            className="h-[40px] w-[100px] border border-blue-500 p-2 mx-auto my-auto text-sm text-blue-500 rounded-full flex items-center gap-2"
          >
      ...
      <div
        className={`items-center text-white gap-5 bg-[#0F0F0F] px-[16px] flex py-2 ${
          search ? "flex" : "hidden"
        }`}
      >
